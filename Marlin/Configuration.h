...
#define STRING_CONFIG_H_AUTHOR "(Kacper-Marciniak)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "GA10 Mk.III*"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -39, 4, -1.62 }
...
#define X_MIN_POS -10//-11
#define Y_MIN_POS -40// -4
#define Z_MIN_POS 0
